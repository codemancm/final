...
<div class="home-container">
    ...
    <div class="home-welcome-message">
        <h1 class="home-title">Welcome to Omega</h1>
    
        <p class="home-text">Dear users,</p>
    
        <p class="home-text">
            I am excited to announce the official release of Omega! Our marketplace script is now fully functional and ready for trading.
        </p>
        ...
        <ul class="home-list">
            ...
            <li>Your contributions and suggestions are always welcome on our GitHub page (github.com/sukunetsiz/omega)</li>
        </ul>
